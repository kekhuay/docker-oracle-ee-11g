...
[ -d "/home/oracle/scripts" ] && chown oracle:dba -R /home/oracle/scripts
[ -d "/u02/recovery_files" ] && chown oracle:dba -R /u02/recovery_files
[ -d "/u03/tbs" ] && chown oracle:dba -R /u03/tbs
